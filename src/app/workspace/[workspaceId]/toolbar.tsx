                ...
                <CommandList>
                    ...
                    <CommandGroup heading="Channels">
                        {channels?.map((channel,id)=>(
                            <CommandItem key={id} onSelect={()=>onChannelClick(channel._id)}>
                                <Link href={`/workspace/${workspaceId}/member/${channel._id}`}>
                                    {channel.name}
                                </Link>
                            </CommandItem>
                        ))}
                    ...
                    {members?.map((member,id)=>(
                            <CommandItem onSelect={()=>onMemberClick(member._id)} key={id}>
